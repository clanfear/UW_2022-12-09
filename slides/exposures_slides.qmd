...
## Exposure to gun violence among adolescents coming of age in Chicago, 1995–2021  {background-image="img/stephan-cassara-KnAIsBuitGg-unsplash.jpg" background-opacity="0.3"}
...
## PHDCN+ wave 4 (2012) {background-image="img/dark/70/max-bender-yb7Yg3Rv7WA-unsplash.jpg" background-opacity="0.1"}
...
## PHDCN+ wave 5 (2021) {background-image="img/dark/70/max-bender-yb7Yg3Rv7WA-unsplash.jpg" background-opacity="0.1"}
...
# Cohort differences in gun use and exposures to gun violence {background-image="img/dark/50/ozzie-stern-dkwJLowVvl4-unsplash.jpg" background-opacity="0.3"}
...
## Probability of event by age 28
...
# Disparities in gun use and exposure to gun violence {background-image="img/dark/50/ozzie-stern-dkwJLowVvl4-unsplash.jpg" background-opacity="0.3"}
...
map_dfr(c("seen_shot", "been_shot", "concealed_carry", "used_gun"), ~ get_spt_estimates(spt_base_models, .x, zval = 1.96)) %>%
  ...
  bind_rows(map_dfr(c("seen_shot", "been_shot", "concealed_carry", "used_gun"), ~ get_spt_estimates(spt_demo_models, .x, zval = 1.96)) |> mutate(spec = "Without Neighborhood")) |>
